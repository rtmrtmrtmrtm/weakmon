...
class FT8I:
    def __init__(self, outcard, descs, cat, oneband):
        ...
        self.rate = 11025
        self.logname = "ft8-log.txt"
        self.allname = "ft8-all.txt"
    ...
    def one(self):
        ...
        # second of 15-second cycle, then break to switch bands.
